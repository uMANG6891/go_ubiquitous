...
//        int mTapCount;
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            mTextDatePaint = createTextPaint(ContextCompat.getColor(getBaseContext(), R.color.primary_light), NORMAL_TYPEFACE);
            ...
            mTextTempLowPaint = createTextPaint(ContextCompat.getColor(getBaseContext(), R.color.primary_light), NORMAL_TYPEFACE);
                ...
                if (dataEvent.getType() == DataEvent.TYPE_CHANGED) {
                    ...
                    if (path.equals(WEATHER_INFO_PATH)) {
                        ...
                        if (dataMap.containsKey(KEY_WEATHER_ID)) {
                            ...
                            Drawable b = ContextCompat.getDrawable(getApplicationContext(), Utility.getIconResourceForWeatherCondition(weatherId));
